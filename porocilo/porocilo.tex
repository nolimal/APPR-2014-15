...
\includegraphics[widht=1.2\textwidth]{../slike/EUSkupno.pdf}
...
\includegraphics[widht=1.2\textwidth]{../slike/EUZenske.pdf}
...
\includegraphics[widht=1.2\textwidth]{../slike/EUMoski.pdf}
...
\includegraphics[widht=1.2\textwidth]{../slike/prebivalstvo.pdf}
